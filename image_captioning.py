...
def generate_caption(feature_extractor, caption_generator, image_path, vocab):
    ...
    for i in range(20):  # max caption length
        outputs = caption_generator(features.unsqueeze(0), captions)
...
if __name__ == "__main__":
    ...
    image_path = 'D:\OneDrive - University of Hertfordshire\ML\Encryptix Internship\path_to_image.jpg'  # Replace with your image path
